    ...
    <>
      <header className="row-start-2 col-span-2 md:col-span-1">
        <H2Cmp
          ...
          classes="text-center text-3xl md:text-start lg:text-customFS2 lg:leading-customLH1 font-bold"
        />
        <ParagraphHolder
          classes="text-center my-6 font-base text-medium text-backup leading-customLH5 md:text-start"
      ...
      <div className="row-start-4 col-span-2 items-center justify-center flex flex-col gap-20 sm:flex-row md:row-start-3 md:col-span-1 md:justify-start md:items-start">
        <LikertScale
